...
FLTLN            equ 0Eh                ; Size of a Float (14)
Prompt           equ 3Eh                ; >
; enum Tokens
tknLowercase     equ 1
tknUppercase     equ 2
...
; Processor       : z80 []
; Target assembler: ZASM by Mockba the Borg
; ===========================================================================
...
loc_8FE1:
                ...
                jr      z, loc_9004
                jr      nc, loc_8FE1
loc_9004:                               ; Subtracts two C bytes long BCDs in (DE) and (HL)
